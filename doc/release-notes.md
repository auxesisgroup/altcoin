0.8.7.5 changes
=============
- openssl-1.0.1k or older versions patched for CVE-2014-8275 broke compatibility with Bitcoin and Altcoin.
  This update patches Altcoin to maintain compatibility with CVE-2014-8275 patched openssl.
- If you are running v0.8.7.4 as distributed by altcoin.org you do not need to upgrade.
  The binaries distributed on altcoin.org contain their own copy of openssl so they are unaffected by this issue.
...
- Minor fixes:
  - s/Bitcoin/Altcoin/ in the Coin Control example
...
- Internal miner added back to Altcoin.  setgenerate now works, although it is generally a bad idea as it is significantly slower than external CPU miners.
