...
#if defined(NDEBUG)
# error "Altcoin cannot be compiled without assertions."
#endif
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "my first altcoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x631b70e26200e09add84e89f994025e235cab8157c9174b4eb1ab007f46d7c29"));
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&AltcoinMiner, pwallet));
}
